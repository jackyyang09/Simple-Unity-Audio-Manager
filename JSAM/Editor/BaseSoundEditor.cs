...
{
    public abstract class BaseSoundEditor : BaseAudioEditor<JSAMSoundFileObject>
    {
        protected override GUIContent audioDesc => new GUIContent("Sound", "Sound that will be played");
        protected override List<JSAMSoundFileObject> audioLibrary => AudioManager.Instance.Library.Sounds;
